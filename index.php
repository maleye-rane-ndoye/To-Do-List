        ...
        <div class="content">
            <article class="box-pre-todo">
                ...
                <span class="display">
                    ...
                    <p>Maleye Rane Ndoye</p>
                 </span>

                 <span class="display">
                 <span class="display">
                 <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-calendar2-event" viewBox="0 0 16 16">
                ...
                <span class="display">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-mortarboard" viewBox="0 0 16 16">
                ...
                <span class="display">
                <svg xmlns="http://www.w3.org/2000/svg" width="26" height="26" fill="currentColor" class="bi bi-database-fill-gear" viewBox="0 0 16 16">
